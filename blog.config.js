...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '老钱303', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '只是想当个老六😎', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.laoqian303.qzz.io/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '老钱303, 博客', // 网站关键词 英文逗号隔开
